    ...
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage your fundraising campaigns and track performance</p>
        </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4 p-3 bg-gray-50 rounded-md">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">$50.00 from John Doe to Campaign for Education</p>
                  </div>
